...
// 			editor.SetTheme(codeditor.GetDefaultTheme())
// 		}),
// 		widget.NewButton("Light", func() {
// 			editor.SetTheme(codeditor.GetLightTheme())
// 		}),
// 		widget.NewButton("VS Code Dark", func() {
// 			editor.SetTheme(codeditor.GetVSCodeDarkTheme())
// 		}),
// 		widget.NewButton("Monokai", func() {
// 			editor.SetTheme(codeditor.GetMonokaiTheme())
// 		}),
// 	)
...
// func CreateCodeEditor(language string, theme *codeditor.Theme) *codeditor.ScriptEditor {
// 	editor := codeditor.NewScriptEditor()
...
// func CreateCodeEditorWithContent(content, language string, theme *codeditor.Theme) *codeditor.ScriptEditor {
